...
class GaussianPacket:
    def __init__(
        ...
        self.gtcolor = self.resize_img(gtcolor, 320) if gtcolor is not None else None
        self.gtdepth = self.resize_img(gtdepth.unsqueeze(0), 320) if gtdepth is not None else None
